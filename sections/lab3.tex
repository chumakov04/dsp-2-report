...
Exact caclulated by adaptive filter values for coefficients $b_0$ = $b_4$, $b_1$ = $b_3$, $b_2$ are shown on Figure~\ref{fig:309}.
...
Only change is the input signal which is real one with sound.wav file that has 2 channels. Time domain spectrum clearly shows noisy disturbed signal overlapped with intereference noise signal (Figure~\ref{fig:310}).
