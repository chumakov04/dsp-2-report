...
\begin{figure}[H]
  ...
  \caption{input signals and filtered result}\label{fig:28}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=0.6\textwidth]{image_46.jpg}
  \caption{b coefficient convergence}\label{fig:29}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=0.6\textwidth]{image_47.jpg}
  \caption{original vs recovered signal and difference}\label{fig:30}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{b coefficient convergence for different mu values}\label{fig:31}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{sound.wav adaptive filtering}\label{fig:32}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=0.6\textwidth]{image_50.jpg}
  \caption{sound.wav b coefficients over time}\label{fig:33}
\end{figure}
