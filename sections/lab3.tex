...
Figure~\ref{fig:307} shows difference signal in time domain between original $x(t)$ (or $s0$ as I used in code and plots) and recovered $e(k)$. As can be seen, most noticable difference is as already observed until 1 second, when FIR filter coefficients settle towards optimal values. However, most difference is actually until 0.3 seconds (not 1 second as I concluded from visual difference between original and recovered signal), after that coefficients converge and difference become minimal with small variance.
