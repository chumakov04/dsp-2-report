...
\begin{figure}[H]
  ...
  \caption{notch filter frequency response and pole-zero map}\label{fig:18}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{same stop frequency, different sample rates}\label{fig:19}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=0.48\textwidth]{image_31.jpg}\hspace{4pt}
  \includegraphics[width=0.48\textwidth]{image_32.jpg}
  \caption{same sample rate, different stop frequencies}\label{fig:20}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{influence of pole radius r on notch filter}\label{fig:21}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{basic comb filter frequency response and pole-zero map}\label{fig:22}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{butterworth lowpass, comb filter with n=3, and pole-zero map}\label{fig:23}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{notch-comb filter frequency response and pole-zero map}\label{fig:24}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=0.6\textwidth]{image_42.jpg}
  \caption{notch-comb filter coefficients}\label{fig:25}
\end{figure}
